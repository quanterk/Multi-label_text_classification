...
def load_data(dataset_str,task_type = "semi"):
    ...
    for i in range(len(names)):
        with open("/home/luods/Desktop/SparseGCN/Codes/gcn/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("/home/luods/Desktop/SparseGCN/Codes/gcn/data/ind.{}.test.index".format(dataset_str))
